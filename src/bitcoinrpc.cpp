...
{
    return GetBoolArg("-testnet", false) ? 111175 : 11175;
}
...
string HTTPPost(const string& strMsg, const map<string,string>& mapRequestHeaders)
{
    ostringstream s;
    s << "POST / HTTP/1.1\r\n"
      << "User-Agent: HCCoin-json-rpc/" << FormatFullVersion() << "\r\n"
      << "Host: 127.0.0.1\r\n"
...
void StartRPCThreads()
{
        ...
        (mapArgs["-rpcuser"] == mapArgs["-rpcpassword"]))
    {
        ...
        string strWhatAmI = "To use HCCoind";
...
Value setgenerate(const Array& params, bool fHelp)
{
    ...
    GenerateHashcoins(fGenerate, pwalletMain);
    return Value::null;
}
